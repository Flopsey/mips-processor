...
#
# mips-processor.tcl: Tcl script for re-creating project 'mips-processor'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/src/constrs/Basys-3.xdc"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "mips-processor"
...
set script_file "mips-processor.tcl"
...
set file "[file normalize "$origin_dir/src/constrs/Basys-3.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/src/constrs/Basys-3.xdc"
